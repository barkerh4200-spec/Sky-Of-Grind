GTCEuStartupEvents.registry('gtceu:recipe_type', event => {
    event.create('adv_processing_plant')
...
GTCEuStartupEvents.registry('gtceu:machine', event => {
    event.create('adv_processing_plant', 'multiblock')
        .rotationState(RotationState.ALL)
        .recipeType('adv_processing_plant')
        ...
        .aisle('#C#C#', '#C#C#', '#CCC#', 'CCKCC', '#CCC#')
            ...
            .where("B", Predicates.blocks('kubejs:adv_high_power_crushing_wheels'))
