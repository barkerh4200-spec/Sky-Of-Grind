ServerEvents.recipes(sog => {
    ...
    sog.recipes.gtceu.assembler('uivmachinecasing')
        ...
        .EUt(32)
        .circuit(8)
        sog.recipes.gtceu.assembler('high_power_casing')
        .itemInputs('8x gtceu:heavy_duty_alloy_t4_plate', 'kubejs:draconium_heavy_plating')
        .itemOutputs('kubejs:high_power_casing')
        .EUt(32)
        .circuit(8)
        sog.recipes.gtceu.assembler('high_power_crushing_wheels')
        .itemInputs('3x gtceu:heavy_duty_alloy_t4_gear', 'kubejs:high_power_casing', 'gtceu:uev_electric_motor')
